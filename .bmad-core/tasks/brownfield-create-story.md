...
Before implementing this story, you MUST read and understand the complete project context:
...
### 5. Post-Development Status Report

**REQUIRED**: After completing the story development, automatically trigger the status report generation:
...
- [ ] Report purpose: "Story: {{Story Title}} completion"
- [ ] Include all technical changes, validation results, and next steps
- [ ] Save to: `PRPs/ai_docs/reports/YYYY-MM-DD_{{story-name}}_status.md`

**Status Report Requirements:**

- Document all files modified during story implementation
- Record functionality testing results
- Note any integration points verified
- Capture any issues or blockers encountered
- Define next session priorities if applicable
- Provide context for future handoff
...
6. **Post-development status report is automatically generated**
...
- **Status report generation is mandatory after each story completion**
- **All project context must be read before starting story implementation**
- **Previous status reports must be reviewed to understand past decisions and context**
